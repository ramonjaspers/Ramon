export const profile = {
  ...
  headline:
    'Hi my name is Ramon 👋. I am a result driven developer with more than eight years of expertise in creating and delivering scalable web and mobile solutions. Currently I am driving FM Group their digital transformation as a Lead Developer.',
...
I am a real people person and prefer face to face contact. In my freetime I like go to the theater 🎭, bake something sweet 🥧, go for a hike 🏞️, do a little gaming now and then ♟️, go to the gym 🏋️, do some socializing 🍺, tinker on my motorcycle 🏍️ and pretend to be bob the builder; renovating my house 🔨👷.`,
  experience: [
    {
      company: 'FM Group',
    ...
    },
    {
      ...
      description:
        'My first project was for Enexis GSA making their appointment portal in PHP with YII. After this I helped updating PTI their legacy PHP systems from php 5.3 to 7 and improve general logic (most of the source code was outsourced from India) also helping migrate SVN to GitHub. Two years in my role evolved into the mobile space with React Native next to helping create PTI their new platform “PTI 3.0” which was built on React, Node.js, TypeScript, gRPC, Camunda and more.',
    },
    {
    ...
    },
    {
      ...
      description:
        "While participating in the Achmea Hackathon at Campus Party Utrecht, I co-created 'Besparta' which was an innovative solution for automated pension building. Our team’s ability to combine a complex financial concept with a user-friendly prototype earned us the first-place prize, highlighting my passion for technical creativity and problem-solving.",
    },
    {
