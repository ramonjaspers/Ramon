...
- **Interactive** - Cursor glow effects, hover animations, and floating background text
- **Print-Ready** - Separate CV view optimized for printing
...
| ----------------------- | --------- | ---------------------------- |
| `--color-primary`       | `#028049` | Brand green, main background |
| `--color-primary-light` | `#04d68f` | Accent green, highlights     |
| `--color-secondary`     | `#a0c4ff` | Soft blue, gradients         |
| `--color-white`         | `#ffffff` | Pure white                   |
| `--color-black`         | `#000000` | Pure black                   |
| `--color-gray-dark`     | `#111111` | Headings, dark text          |
| `--color-gray-medium`   | `#333333` | Body text                    |
